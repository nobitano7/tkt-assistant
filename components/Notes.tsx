        ...
        <div>
            ...
            <div className="space-y-3">
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
                    {notes.length === 0 ? (
                        <p className="text-sm text-slate-500 text-center py-2">Chưa có ghi chú nào.</p>
                    ) : (
                        notes.map(note => (
                            <div key={note.id} className="flex items-center space-x-2 bg-white p-2 rounded-lg border border-slate-200 group">
                                ...
                                <button
                                    ...
                                    className="p-1 rounded-full text-slate-400 hover:bg-slate-200 hover:text-slate-600 opacity-0 group-hover:opacity-100 transition-opacity"
